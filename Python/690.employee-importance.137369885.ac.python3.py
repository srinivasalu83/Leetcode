...
class Solution:
    def getImportance(self, employees, id):
        ...
        return self._getImportance(record, id)
    
    def _getImportance(self, record, id):
        return record[id][0] + sum(self._getImportance(record, subordinate_id) for subordinate_id in record[id][1])
